...
Below is a Spanish news article. Your task has two parts:

1. SIMPLIFY: Rewrites sentences that are too complex, too formal, or use difficult grammatical structures.
...
2. TRANSLATE DIFFICULT WORDS: For any word that is:
